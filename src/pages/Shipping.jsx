        ...
        <div className="info-sections">
          <section className="info-section">
            ...
            <div className="shipping-options">
              <div className="shipping-option">
                ...
                <p>Delivered via standard courier service. Tracking information will be provided via email and SMS.</p>
              </div>
              <div className="shipping-option">
          ...
          <section className="info-section">
            ...
            <ul className="info-list">
              ...
              <li>You will receive SMS and email notifications about delivery attempts</li>
