  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: 'Yes! Once your order is shipped, you will receive a tracking number via email and SMS. You can track your order in the "Track Order" section of your dashboard.'
        },
        {
      ...
      questions: [
        {
          ...
          a: 'Click "Create Account" in the header or footer, enter your mobile number, password, and name. Email is optional. You can also checkout as a guest.'
        },
        {
          q: 'I forgot my password. How do I reset it?',
          a: 'Go to the Dashboard, click "Login", then "Forgot Password". Enter your mobile number, and follow the instructions to reset your password.'
        },
        {
